...
#ifndef _SMART_SQLCLR_AGGREGATES__SORTEDLISTCREATOR_H_
#define _SMART_SQLCLR_AGGREGATES__SORTEDLISTCREATOR_H_
...
namespace Aggregates {
	...
	/**
	 * @class SortedListCreator
	 *
	 * @brief Can be used to create sorted Lists in SQL
	 *
	...
	public ref class SortedListCreator sealed : public IBinarySerialize {
	private:
		// Constants
	...
	public:
		 ...
		 *
		 */
		void Merge(SortedListCreator^ value);
...
#endif // _SMART_SQLCLR_AGGREGATES__SORTEDLISTCREATOR_H_
