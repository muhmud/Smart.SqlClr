...
#ifndef _SMART_SQLCLR_AGGREGATES__DICTIONARYCREATORZ_H_
#define _SMART_SQLCLR_AGGREGATES__DICTIONARYCREATORZ_H_
...
namespace Aggregates {
	...
	/**
	 * @class DictionaryCreatorZ
	 *
	 * @brief Can be used to create compressed Dictionary objects in SQL
	 *
	...
	public ref class DictionaryCreatorZ sealed : public IBinarySerialize {
	private:
		// Constants
	...
	public:
		 ...
		 *
		 */
		void Merge(DictionaryCreatorZ^ value);
...
#endif // _SMART_SQLCLR_AGGREGATES__DICTIONARYCREATORZ_H_
