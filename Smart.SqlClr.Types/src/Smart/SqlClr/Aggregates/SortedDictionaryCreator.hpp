...
#ifndef _SMART_SQLCLR_AGGREGATES__SORTEDDICTIONARYCREATOR_H_
#define _SMART_SQLCLR_AGGREGATES__SORTEDDICTIONARYCREATOR_H_
...
namespace Aggregates {
	...
	/**
	 * @class SortedDictionaryCreator
	 *
	 * @brief Can be used to create sorted Dictionary objects in SQL
	 *
	...
	public ref class SortedDictionaryCreator sealed : public IBinarySerialize {
	private:
		// Constants
	...
	public:
		 ...
		 *
		 */
		void Merge(SortedDictionaryCreator^ value);
...
#endif // _SMART_SQLCLR_AGGREGATES__SORTEDDICTIONARYCREATOR_H_
