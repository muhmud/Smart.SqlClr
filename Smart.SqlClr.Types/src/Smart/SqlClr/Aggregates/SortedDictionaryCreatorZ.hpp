...
#ifndef _SMART_SQLCLR_AGGREGATES__SORTEDDICTIONARYCREATORZ_H_
#define _SMART_SQLCLR_AGGREGATES__SORTEDDICTIONARYCREATORZ_H_
...
namespace Aggregates {
	...
	/**
	 * @class SortedDictionaryCreatorZ
	 *
	 * @brief Can be used to create sorted & compressed Dictionary objects in SQL
	 *
	...
	public ref class SortedDictionaryCreatorZ sealed : public IBinarySerialize {
	private:
		// Constants
		literal bool Sorted = true;
	...
	public:
		 ...
		 *
		 */
		void Merge(SortedDictionaryCreatorZ^ value);
...
#endif // _SMART_SQLCLR_AGGREGATES__SORTEDDICTIONARYCREATORZ_H_
