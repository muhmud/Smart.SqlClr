...
#ifndef _SMART_SQLCLR_AGGREGATES__SORTEDLISTCREATORZ_H_
#define _SMART_SQLCLR_AGGREGATES__SORTEDLISTCREATORZ_H_
...
namespace Aggregates {
	...
	/**
	 * @class SortedListCreatorZ
	 *
	 * @brief Can be used to create sorted & compressed Lists in SQL
	 *
	...
	public ref class SortedListCreatorZ sealed : public IBinarySerialize {
	private:
		// Constants
	...
	public:
		 ...
		 *
		 */
		void Merge(SortedListCreatorZ^ value);
...
#endif // _SMART_SQLCLR_AGGREGATES__SORTEDLISTCREATORZ_H_
