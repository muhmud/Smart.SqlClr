...
#ifndef _SMART_SQLCLR_AGGREGATES__LISTCREATOR_H_
#define _SMART_SQLCLR_AGGREGATES__LISTCREATOR_H_
...
namespace Aggregates {
	 ...
	 * @class ListCreator
	 *
	 * @brief Can be used to create Lists in SQL
	 *
	...
	public ref class ListCreator sealed : public IBinarySerialize {
	private:
		// Constants
...
#endif // _SMART_SQLCLR_AGGREGATES__LISTCREATOR_H_
